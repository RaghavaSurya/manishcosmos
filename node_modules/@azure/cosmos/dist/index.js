(function (global, factory) {
    ...
    const extractAggergateResult = (payload) => payload.item2 ? payload.item2 : payload.item;
            ...
            return tslib.__awaiter(this, void 0, void 0, function* () {
                ...
                if (this.preferredLocations && this.preferredLocations.length > 0) {
                    for (const preferredLocation of this.preferredLocations) {
                        location = locations.find((loc) => loc.unavailable !== true && loc.name === preferredLocation);
                        if (location) {
                            break;
                        }
                    }
